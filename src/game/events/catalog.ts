...
import {LEATHER_EVENTS} from './content/leather';
...
export const PRODUCTION_EVENT_CATALOG:ExpeditionEventDefinition[]=[...COMMON_EVENTS,...ORE_EVENTS,...KALEON_EVENTS,...LEATHER_EVENTS];
...
export const EVENT_ASSETS:Record<string,string>={
 dev_mine_backdrop:'./assets/backgrounds/ore/t1.png',
 potion:'./assets/ui/inventory/health.png',
 ore:'./assets/ui/inventory/ore.png',
 silver:'./assets/ui/pixel-v1/13-silver-icon.png',
 ore_exposed_vein:'./assets/events/ore/ore_exposed_vein.webp',
 ore_derailed_cart:'./assets/events/ore/ore_derailed_cart.webp',
 ore_clear_air_pocket:'./assets/events/ore/ore_clear_air_pocket.webp',
 ore_stranded_surveyor:'./assets/events/ore/ore_stranded_surveyor.webp',
 ore_reinforced_workbench:'./assets/events/ore/ore_reinforced_workbench.webp'
};
