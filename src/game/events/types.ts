...
export interface ExpeditionEventDefinition {id:string;type:EventType;title:string;description:string;imageAssetKey?:string;towerIds?:Tower[];tiers?:number[];floors?:number[];weight:number;conditions?:EventCondition[];choices:EventChoice[];rewardPreview?:{label:string;iconAssetKey?:string;note?:string}[];metadata?:{fixture?:boolean}}
