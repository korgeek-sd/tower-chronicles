...
export function inventoryView(s:GameState):InventoryViewItem[]{
 ...
 potionIds.forEach((p,order)=>add({category:'potions',sourceId:p,name:POTIONS[p].name+' 포션',quantity:s.potions[p],iconId:p,description:POTIONS[p].description,order,stack:true}));
