...
export function BattleScreen({game,onBasicAttack,onSkill,onPotion,onFlee,onHome,onRevival}:Props){
 ...
 return <div className="battle-screen immersive-battle">
  ...
  {menu&&<section className="battle-drawer" aria-label="전투 메뉴"><div className="drawer-heading"><h2>원정 기록</h2><button onClick={()=>setMenu(false)} aria-label="전투 메뉴 닫기">×</button></div><button onClick={onHome}>거점 / 장비 / 스킬 관리 →</button><ExpeditionLootPanel expedition={e}/><h3>전투 기록</h3>
