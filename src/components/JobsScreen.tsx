...
const PAGE_SIZE=5;
export function JobsScreen({game,setGame,onSelectJob}:{game:GameState;setGame:React.Dispatch<React.SetStateAction<GameState>>;onSelectJob?:(jobId:string)=>void}){
