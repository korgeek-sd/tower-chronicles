...
returns numeric language sql immutable set search_path='' as $$
 select case p_reaction when 'vanguard_counter' then .68 when 'counter_strike' then .9 when 'matriarch_bite' then .9 when 'refraction_tail' then .72 when 'echo_burst' then .8 else .8 end
$$;
